...
export const TASKS: Record<string, TaskRowData> = {
  ...
  inProgress: {
    ...
    type: { slug: "review", label: "Review", icon: "eye", tone: "sky" },
  ...
  highPriority: {
    ...
    type: { slug: "admin", label: "Admin", icon: "settings", tone: "amber" },
    status: { id: "c-todo", name: "To Do", kind: "open" },
    priority: "high",
  ...
  blocked: {
    ...
    type: { slug: "internal", label: "Internal", icon: "clipboard-list", tone: "gray" },
  ...
  overdue: {
    ...
    type: { slug: "meeting", label: "Meeting", icon: "users", tone: "green" },
